...
function values(formData: FormData) {
  ...
  return { direction, departureAt: departureAt.toISOString(), carModel, price, petFriendly, notes, stops, startingCity: direction === "berlin-zagreb" ? "Berlin" : "Zagreb", destinationCity: direction === "berlin-zagreb" ? "Zagreb" : "Berlin" } as const;
}
