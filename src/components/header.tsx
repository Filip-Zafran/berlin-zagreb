    ...
    <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-stone-50/90 backdrop-blur-xl">
      <div className="mx-auto flex h-18 max-w-[1440px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Main navigation" className="flex items-center gap-1 sm:gap-2">
          <Link href="/login" className="focus-ring hidden min-h-10 items-center rounded-xl px-3 text-sm font-semibold text-slate-600 hover:bg-white hover:text-slate-950 sm:inline-flex">
            Log in
          </Link>
          <Link href="/register" className="focus-ring hidden min-h-10 items-center rounded-xl px-3 text-sm font-semibold text-slate-600 hover:bg-white hover:text-slate-950 sm:inline-flex">
            Register
          </Link>
